...
Стек: React, Next.js, TypeScript, Redux/Zustand, Tailwind, Node.js, Nest.js, PostgreSQL.

# 🚀 Что я умею
✅ Разработка производительных, масштабируемых и удобных веб-приложений.
✅ Опыт в создании e-commerce платформ, корпоративных сайтов и интерактивных сервисов.
✅ Оптимизация фронтенд-архитектуры и улучшение UX.
✅ Работа с SSR, API, аутентификацией и серверной логикой на Nest.js.
